            ...
            {loading ? (
                ...
                data && (
                    <Card bordered={false}>
                        ...
                        <Title level={3} style={{textAlign: 'center', marginBottom: '0px', paddingBottom: '5px'}}>Giấy
                            Xác Nhận Đề xuất </Title>
                        <Title level={3} style={{
                            textAlign: 'center',
                            marginBottom: '5px',
                            marginTop: '0'
                        }}>{data.data.title}</Title>
                        <Text strong>Nội dung:</Text> <Text
                        style={{fontSize: '20px'}}>{data.data.description}</Text><br></br>
                            ...
                            <Row gutter={16}>
                                ...
                                <Col span={16}>
                                    <Text strong>Trạng thái: <span className="ms-2" style={{
                                        fontSize: '18px',
                                        marginLeft: '15px'
                                    }}>{getStatusTag(data.data.status)}</span></Text>
                                </Col>
                            </Row>
                        </div>
