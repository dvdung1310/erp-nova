...
import FileListCard from './overViewProject/FileListCard';
...
const TaskList = lazy(() => import('./overViewProject/TaskList'));
const Activities = lazy(() => import('./overViewProject/Activities'));
