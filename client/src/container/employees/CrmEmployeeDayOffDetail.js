    ...
    <div style={{ background: '#fff', marginTop: '30px', padding: '50px' }}>
      <div>
        <div style={{ display: 'flex', justifyContent: 'left' }}>
          <img src={userImage} alt="User" width={120} height={120} />
        </div>
        ...
        <div style={{ marginTop: '50px' }}>
          ...
          <h4>
            Thời gian:
            {format(new Date(dayOffDetail.day_off_start), 'dd/MM/yyyy')} -{' '}
            {format(new Date(dayOffDetail.day_off_end), 'dd/MM/yyyy')}
          </h4>
        ...
        {dayOffDetail.off_status === 0 && (
          <div style={{ display: 'flex', justifyContent: 'end', marginTop: '50px' }}>
            <Button
              ...
              style={{ marginRight: '10px', backgroundColor: '#1890ff', borderColor: '#1890ff' }} // Thiết lập màu nền
        ...
        {dayOffDetail.off_status === 1 && (
          <Button
            type="primary" // Sử dụng màu chính của antd
            style={{ marginTop: '50px', display: 'block', marginLeft: 'auto', backgroundColor: '#1890ff', borderColor: '#1890ff' }} // Thiết lập màu nền
            onClick={() => handleStatusUpdate(1)}
          >
           Đã Xác nhận đơn
          </Button>
        ...
        {dayOffDetail.off_status === 2 && (
          <Button
            type="default" // Sử dụng kiểu nút mặc định
            style={{ marginTop: '50px', display: 'block', marginLeft: 'auto', backgroundColor: '#ff4d4f', borderColor: '#fff' }} // Thiết lập màu nền
            onClick={() => handleStatusUpdate(2)}
          >
