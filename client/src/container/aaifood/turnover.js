...
import { reportRevenue, filterRevenueFood } from '../../apis/aaifood/index';
...
const list_order_agency = () => {
  ...
  const handleFilter = async (values) => {
    try {
      ...
      console.log('====================================');
      setOrderRetail(response.all_order_retail);
      setOrderAgency(response.all_order_agency);
      setProfit(response.total_profit_all);
      setPaymentSlip(response.all_payment_slip);
