...
function MenuItems({darkMode, toggleCollapsed, topMenu, events}) {
    ...
    return (
        <Menu
            ...
            openKeys={openKeys}
        >
            <SubMenu style={{display: 'none'}} key="dashboard" icon={!topMenu && <FeatherIcon icon="home"/>}
                     title="Dashboard">
                <Menu.Item key="home">
            ...
            {/* novaup */}
            <SubMenu style={{display: 'none'}} key="novaup" icon={!topMenu && <FeatherIcon icon="home"/>}
                     title="Novaup">
            ...
            {/* Tuyển dụng   */}
            {/* Tuyển dụng */}
            <SubMenu style={{display: 'none'}} key="tuyendung" icon={!topMenu && <FeatherIcon icon="home"/>}
                     title="Tuyển dụng">
                <Menu.Item key="nvu-home">
            ...
            <SubMenu style={{display: 'none'}}>
                <SubMenu className='d-none' key="layout" icon={!topMenu && <FeatherIcon icon="layout"/>}
                         title="Layouts">
                    <Menu.Item key="light">
                        <NavLink
                            onClick={() => {
                ...
                <Menu.Item
                    icon={
                        !topMenu && (
                            <ReactSVG className="sDash_menu-item-icon"
                                      src={require('../static/img/icon/columns.svg').default}/>
                        )
                    }
                    key="kanban"
                >
                ...
                <SubMenu
                    ...
                    icon={
                        !topMenu && (
                            <ReactSVG className="sDash_menu-item-icon"
                                      src={require('../static/img/icon/repeat.svg').default}/>
                        )
                    }
            ...
            Forms<span className="badge badge-success">New</span>
                ...
                <SubMenu
                    key="knowledgebase"
                    icon={
                        !topMenu && <ReactSVG className="sDash_menu-item-icon"
                                              src={require('../static/img/icon/book.svg').default}/>
                    }
                ...
                <Menu.Item
                    icon={
                        !topMenu && (
                            <ReactSVG className="sDash_menu-item-icon"
                                      src={require('../static/img/icon/headphone.svg').default}/>
                        )
                    }
                    key="support"
                >
