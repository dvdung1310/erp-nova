...
import {getNotifications, getNotificationWarning, updateStatusNotification} from "../../../apis/work/user";
...
function MessageBox() {
    ...
    const getNotify = async () => {
        try {
            ...
            const response = await getNotificationWarning();
    ...
    useEffect(() => {
        if (socketConnection) {
            ...
            socketConnection.on('notification-warning', receiveNotification);
